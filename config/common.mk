...
$(call inherit-product-if-exists, vendor/lineage/config/lineagex.mk)
$(call inherit-product-if-exists, vendor/addons/config.mk)

PRODUCT_BRAND ?= LineageX
...
# Increase LineageX Version with each major release.
LINEAGEX_VERSION := Beta

LINEAGE_VERSION := LineageX-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-v$(LINEAGEX_VERSION)
LINEAGE_DISPLAY_VERSION := LineageX-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(LINEAGE_BUILD)-v$(LINEAGEX_VERSION)
